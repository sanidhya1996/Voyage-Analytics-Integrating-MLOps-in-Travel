...
scaler_model = joblib.load(open("Gender classification/scaler.pkl", 'rb'))
pca_model = joblib.load(open("Gender classification/pca.pkl", 'rb'))
logistic_model = pickle.load(open("Gender classification/tuned_logistic_regression_model.pkl", 'rb'))
